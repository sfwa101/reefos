// Sovereign Catalog Adapter — Phase 15.2
// ---------------------------------------------------------
// Single read/write surface over the Universal Sovereign Catalog
// (salsabil_assets ─ skus ─ financial_contracts ─ inventory_matrix).
//
// All callsites that used to hit the dead `public.products` table now
// route through these helpers. Data is mapped back into the legacy
// shapes the UI expects (Product, RestoProduct, PosProduct, Inventory
// rows). Mutations target the appropriate Sovereign table by sku_id.
