/**
 * Group-Buy contract — moved into the kernel as a port (Constitution v5.1
 * Article 2 / Kernel Purity). The vertical app re-exports these types so
 * existing imports under `@/apps/reef-al-madina/features/group-buy` keep
 * working, while the kernel only depends on this neutral contract.
 */
