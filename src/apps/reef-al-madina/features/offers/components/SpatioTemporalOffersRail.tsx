/**
 * SpatioTemporalOffersRail — Phase 29 Stem Cell.
 * ----------------------------------------------
 * Self-contained section that renders the live spatio-temporal offers
 * matrix as a stack of Level-3 SDUI blocks. Wrapped here so the parent
 * `<Offers />` page can become a pure `<LayoutFactory pageKey="offers_hub" />`
 * shell while we keep the rich offer-matrix → SduiRenderer pipeline working
 * underneath.
 */
...
export default SpatioTemporalOffersRail;
