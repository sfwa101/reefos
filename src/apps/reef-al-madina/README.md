...
All features here consume the OS kernel under `@/core/*`:
- **Tayseer** (`@/core/finance`) — wallet, balance, savings, charity
...
- **System Editor** (`@/core/runtime-ui/system-editor`) — visual layout editor
